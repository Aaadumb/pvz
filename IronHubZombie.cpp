...
IronHubZombie::IronHubZombie(int row, int y, QWidget* parent) {
	...
	this->moviePic[NORMAL] = IronHubZombieWalkPic;
	this->moviePic[ATTACKING] = IronHubZombieAttackingPic;
...
bool IronHubZombie::zombieMoving(bool& isGameOver) {
...
void IronHubZombie::zombieReleaseSkill(Plant* (&v)[6][10], vector<pair<int, int>>& diePlant) {
